...
var Dimensions = ReactNative.Dimensions, View = ReactNative.View, Animated = ReactNative.Animated,
    ScrollView = ReactNative.ScrollView, StyleSheet = ReactNative.StyleSheet, Platform = ReactNative.Platform;
var SceneComponent = require('./SceneComponent');
var _require = require('./DefaultTabBar'), DefaultTabBar = _require.DefaultTabBar;
var _require2 = require('./ScrollableTabBar'), ScrollableTabBar = _require2.ScrollableTabBar;
var ScrollableTabView = (0, _createReactClass2.default)({
    displayName: 'ScrollableTabView',
    statics: {DefaultTabBar: DefaultTabBar, ScrollableTabBar: ScrollableTabBar},
    propTypes: {
    ...
    getDefaultProps: function getDefaultProps() {
        return {
            tabBarPosition: 'top', initialPage: 0, page: -1, onChangeTab: function onChangeTab() {
            }, onScroll: function onScroll() {
            }, contentProps: {}, scrollWithoutAnimation: false, locked: false, prerenderingSiblingsNumber: 0
        };
    },
    ...
    updateSceneKeys: function updateSceneKeys(_ref) {
        var page = _ref.page, _ref$children = _ref.children,
            children = _ref$children === undefined ? this.props.children : _ref$children, _ref$callback = _ref.callback,
    ...
    newSceneKeys: function newSceneKeys(_ref2) {
        ...
        var _ref2$previousKeys = _ref2.previousKeys,
            ...
            currentPage = _ref2$currentPage === undefined ? 0 : _ref2$currentPage, _ref2$children = _ref2.children,
    ...
    renderScrollableContent: function renderScrollableContent() {
        ...
        }, this.props.contentProps, {__source: {fileName: _jsxFileName, lineNumber: 182}}), scenes);
    },
    ...
    _onChangeTab: function _onChangeTab(prevPage, currentPage) {
        this.props.onChangeTab({i: currentPage, ref: this._children()[currentPage], from: prevPage});
    },
...
var styles = StyleSheet.create({container: {flex: 1}, scrollableContentAndroid: {flex: 1}});
